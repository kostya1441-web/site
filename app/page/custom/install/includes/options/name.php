                ...
                <div class="input-form">
                    <div class="input_text">
                        ...
                        <div class="servers_info">
                            <input name="servers_info" value="" placeholder="<?php echo $options['language'] == 'EN' ? 'The best CS2 game server network with huge online and top admins!' : 'Лучшая сеть игровых серверов по CS2 с огромным онлайном и лучшими админами!'?>" required>
                        </div>
                    </div>
                </div>
            </div>
