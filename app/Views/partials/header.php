...
<header class="header" id="header">
    <div class="container header__inner">
        ...
        <form class="search" action="/catalog" method="get" role="search">
        ...
        <div class="header__actions">
            ...
            <a class="cart-button" href="/cart" data-cart-link>
    ...
    <nav class="nav" id="nav" data-menu>
        <div class="container nav__inner">
            <a class="nav__link<?= is_active('/') ? ' is-active' : '' ?>" href="/">Главная</a>
            <div class="nav__dropdown">
                <a class="nav__link<?= is_active('/catalog') ? ' is-active' : '' ?>" href="/catalog">Каталог</a>
            ...
            <a class="nav__link<?= is_active('/delivery') ? ' is-active' : '' ?>" href="/delivery">Доставка и оплата</a>
            <a class="nav__link<?= is_active('/about') ? ' is-active' : '' ?>" href="/about">О нас</a>
            <a class="nav__link<?= is_active('/contacts') ? ' is-active' : '' ?>" href="/contacts">Контакты</a>
