...
<article class="card<?= $inStock ? '' : ' card--out' ?>">
    <a class="card__media" href="/product/<?= e($product['slug']) ?>">
    ...
    <div class="card__body">
        <h3 class="card__title"><a href="/product/<?= e($product['slug']) ?>"><?= e($product['name']) ?></a></h3>
        ...
        <div class="card__footer">
            ...
            <form class="card__form" method="post" action="/cart/add" data-cart-form>
                <?= csrf_field() ?>
